...
public class AdminHomePageController {
	...
	/**
	 * Used to initialize the admin home page. 
	 * @param primaryStage
	 */
	...
	/**
	 * If user clicks "Add User" : captures string input from 'username' and 'password' text fields
	 * and creates a User object with the data. Adds the User object to the global user list.
	 * Resets the List View after user is added. Cannot add blank user/pass or taken username.
	 * @param event
	 * @throws IOException
	 */
	public void addUser(ActionEvent event) throws IOException {
		...
		if(name.isBlank() || pass.isBlank()) {
			...
			Alert alert = new Alert(AlertType.WARNING ,  "Cannot use this username.", ButtonType.OK);
			alert.showAndWait();
		}
	...
	/**
	 * Used in addUser to check if a user with this name already exists.
