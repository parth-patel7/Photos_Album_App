...
public class LoginController {
	...
	/**
	 * Checks if login is valid. User must exist.
	 * Sets global current user and index.
	 * Initializes "stock" user and album if it DNE.
	 * @param event
	 * @throws IOException
	 */
	@FXML
	...
	/**
	 * Alert used in loginButton if user DNE.
	 */
	...
	/**
	 * Checks if user exists, given it's name.
	 * @param name
